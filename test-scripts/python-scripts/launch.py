...
BASH_SCRIPT_FNS = collections.OrderedDict ([
                   ("PREPARE-ENV", ["prepare-env.sh", "main"]),
                   ("CLEAN-TEST-SYSTEM", ["clean_test.sh", "clean"]),
                   ("PHY-OVS-PHY-TEST", ["phy-ovs-phy.sh", "menu"]),
                   ("PHY-VM-PHY-TEST", ["phy-vm-phy.sh", "menu"]),
                   ("PHY-DOCKER-PHY-TEST", ["phy-docker-phy.sh", "menu"]),
                   ("PHY-KATA-PHY-TEST", ["phy-kata-phy.sh", "menu"]),
                   ("BUILD-OVS-DPDK-NATIVE", ["build_script.sh", "build_ovs"]),
                   ("BUILD-OVS+DPDK-PERF", ["build_script.sh", "build_ovs_and_dpdk_perf"]),
